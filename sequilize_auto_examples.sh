...
## All models
# ./node_modules/.bin/sequelize-auto -h localhost -d postgres -u postgres -x postgres -p 5432 --dialect postgres -o ./models-development -l ts

## Single table
# ./node_modules/.bin/sequelize-auto -h localhost -d postgres -u postgres -x postgres -p 5432 --dialect postgres -o ./models-development -t config -l ts